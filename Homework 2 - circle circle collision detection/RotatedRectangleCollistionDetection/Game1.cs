...
using RotatedRectangleCollistionDetection.Sprites;
using System;
...
namespace RotatedRectangleCollistionDetection
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // optionaly test using "ball" (circle)
            var playerTexture = Content.Load<Texture2D>("rotated_rectangle");
            var obstacleTexture = Content.Load<Texture2D>("rotated_rectangle_two");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //    {
            //        sprite.DrawWithRotation(spriteBatch);
            //    } else
            //    {
            //        sprite.DrawAsCircle(spriteBatch);
            //    }
            //}
